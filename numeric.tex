...
В результате его работы были получены следующие решения: \picref{pic:comsol-example-1}, \picref{pic:comsol-example-2},
\picref{pic:comsol-example-3}, \picref{pic:comsol-example-4}, \picref{pic:comsol-example-5}

% TODO(i.kosolapov): Replace with actual comsol data
...
Примеры результатов работы данной программы: \picref{pic:fiber-example-1}, \picref{pic:fiber-example-2},
\picref{pic:fiber-example-3}, \picref{pic:fiber-example-4}, \picref{pic:fiber-example-5}.
